...
const NewCommonComponent = (props) => {
    ...
    <div>
      ...
      >
        ...
        <Option value="option3">10 Case</Option>
                      ...
                      <input type='text' placeholder='Quantity' style={{ width: '70px',border:"1px solid black",height:"30px" }}/> 
                      </td>

                      <td style={{ border: "1px solid black", textAlign: "center", fontWeight: "600", fontFamily: "sans-serif", color: "#1C2833" }} className='p-2'>
                        {/* <h6 style={{ fontWeight: "700", fontFamily: "sans-serif",fontSize:"12px" }} >Today Deal</h6> */}
                      <input type='text' placeholder='Scheme' style={{ width: '80px',border:"1px solid black",height:"30px" }}/> 
...
export default NewCommonComponent